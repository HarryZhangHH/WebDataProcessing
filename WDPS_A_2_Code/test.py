...
model.fit(text_train, Y_train, epochs=5, batch_size=1000, validation_split=0.1, verbose=1)

model.save_weights('./model_4_text/my_checkpoint')

print(model.evaluate(text_test, Y_test, verbose=1))"""
...
model.load_weights('./model_4_text/my_checkpoint')
print(model.evaluate(text_test, Lt_test, verbose=1))
